# -*- coding: utf-8 -*-
#
# BcdaQWidgets documentation build configuration file, created by
# sphinx-quickstart on Fri Jul 05 13:36:40 2013.
#
...
versioneer_version = bcdaqwidgets.__version__.split('+')
...
htmlhelp_basename = 'BcdaQWidgetsdoc'
